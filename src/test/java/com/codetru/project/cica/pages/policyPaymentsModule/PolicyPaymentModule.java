package com.codetru.project.cica.pages.policyPaymentsModule;
...
public class PolicyPaymentModule { 
	...
	private By reccurringPolicyErrText=By.xpath("//*[text()=' Policy is currently on recurring payment. ']");
	...
	private By allBtn=By.xpath("//ion-button[.='All ']");
	...
	private By paymentPolicyNumbers=By.xpath("(//td[text()='']/preceding-sibling::td/a) | (//td[text()='Off-Failed']/preceding-sibling::td/a)");
	...
	private By validPolicyNumbers = By.xpath("//td[text()='Off-Failed']/preceding-sibling::td/a");
	private By searchingSpinner = By.xpath("//div[text()='Searching...']");
	private By customersTab=By.xpath("//ion-button[.=' Customers ']");
	private By directCustomersBtn=By.xpath("(//ion-button[.='Direct Customers'])[2]");
	private By terminatedPolicy=By.xpath("//ion-col[.=' Terminated ']");
	private By pleaseWaitSpinner = By.xpath("//div[text()='Please Wait…']/parent::div");
	private By policyNumbersInCustomersTab=By.xpath("//tbody/tr/td[1]");
